...
import { DVD } from './DVD';
export class bigDVD extends DVD {
    ...
    onInitialize(engine) {  
        ...
        this.vel = new ex.Vector(Math.random() * 240 - 20, Math.random() * 240 - 20);
        // flip
        this.scale = new ex.Vector(Math.random() * 0.5 + 1, Math.random() * 0.5 + 1);
